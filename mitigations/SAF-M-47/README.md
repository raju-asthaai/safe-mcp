# SAF-M-47: Cross-Chain Transaction Graph Analysis

## Overview

**Mitigation ID**: SAF-M-47  
...
- **[SAF-M-2: Comprehensive Logging](../SAF-M-2/README.md)**: Logs provide data for graph analysis
- **[SAF-M-10: Anomaly Detection](../SAF-M-10/README.md)**: Graph patterns feed into anomaly detection
- **[SAF-M-46: Bridge Risk Management](../SAF-M-46/README.md)**: Risk scores inform bridge allowlisting
- **[SAF-M-48: Custodial Off-Ramp Monitoring](../SAF-M-48/README.md)**: Graph analysis identifies off-ramp destinations
