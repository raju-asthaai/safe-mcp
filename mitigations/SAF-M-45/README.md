# SAF-M-45: Tool Manifest Signing & Server Attestation
...
- **[SAF-T1001](../../techniques/SAF-T1001/README.md)** Tool Poisoning Attack (TPA) — malicious instructions hidden in tool descriptions/annotations
- **[SAF-T1402](../../techniques/SAF-T1402/README.md)** Instruction Steganography — hidden directives via zero-width chars/comments in metadata
- **[SAF-T1102](../../techniques/SAF-T1102/README.md)** Prompt Injection (Multiple Vectors) — when delivered through tool annotations
- **SAF-T1701** Cross-Tool Contamination — when tainted tools are propagated between servers/agents
...
SAF-M-45 requires two complementary controls:
...
- **[SAF-M-37](../SAF-M-37/README.md)** Metadata Sanitization
- **[SAF-M-38](../SAF-M-38/README.md)** Schema Validation  
- **[SAF-M-43](../SAF-M-43/README.md)** Steganography Scanner
- **[SAF-M-44](../SAF-M-44/README.md)** Behavioral Monitoring
...
- Clients that don't implement SAF-M-45 can still read tools, but **won't be protected** against T1001/T1402 origin-tampering
...
### SAF-MCP Framework
- [SAF-MCP Repository](https://github.com/SAF-MCP/saf-mcp) - Overview & technique index (for T1001 and related TTPs)
- [SAF-MCP Pull Requests](https://github.com/SAF-MCP/saf-mcp/pulls) - Related mitigations (SAF-M-37/38/39/40/41/42/43/44)
