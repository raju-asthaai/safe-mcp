# SAF-M-29: Explicit Privilege Boundaries

## Overview
**Mitigation ID**: SAF-M-29  
...
## Mitigates
- [SAF-T1703](../../techniques/SAF-T1703/README.md): Tool-Chaining Pivot
- [SAF-T1104](../../techniques/SAF-T1104/README.md): Over-Privileged Tool Abuse
- [SAF-T1112](../../techniques/SAF-T1112/README.md): Sampling Request Abuse — per-server policy gating for whether `sampling/createMessage` is permitted, and treating tool-enabled sampling (`sampling.tools` capability) as a separate higher-privilege tier
...
- [SAF-M-20](../SAF-M-20/README.md): Anomaly Detection
