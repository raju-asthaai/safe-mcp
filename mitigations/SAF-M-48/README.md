# SAF-M-48: Custodial Off-Ramp Monitoring

## Overview

**Mitigation ID**: SAF-M-48  
...
- [SAF-T1915](../../techniques/SAF-T1915/README.md): Cross-Chain Laundering via Bridges/DEXs
...
- **[SAF-M-2: Comprehensive Logging](../SAF-M-2/README.md)**: Logs all off-ramp deposits for analysis
- **[SAF-M-10: Anomaly Detection](../SAF-M-10/README.md)**: Detects unusual off-ramp deposit patterns
- **[SAF-M-46: Bridge Risk Management](../SAF-M-46/README.md)**: Correlates bridge usage with off-ramp deposits
- **[SAF-M-47: Cross-Chain Transaction Graph Analysis](../SAF-M-47/README.md)**: Provides full transaction context for off-ramp deposits
