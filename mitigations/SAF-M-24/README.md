# SAF-M-24: Supply Chain Security - SBOM Generation and Verification

## Overview
**Mitigation ID**: SAF-M-24  
...
- [SAF-T1203](../../techniques/SAF-T1203/README.md): Backdoored Server Binary
...
## Related Mitigations
- [SAF-M-6](../SAF-M-6/README.md): Tool Registry Verification - Complementary registry-based controls
- [SAF-M-2](../SAF-M-2/README.md): Cryptographic Integrity for Tool Descriptions - Provides signature verification
- [SAF-M-9](../SAF-M-9/README.md): Sandboxed Testing - Runtime protection for untrusted components
