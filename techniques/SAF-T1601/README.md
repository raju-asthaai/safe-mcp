...
### Preventive Controls
1. **[SAF-M-44: Network Segmentation](../../mitigations/SAF-M-44/README.md)**: Isolate MCP servers in protected network segments with strict firewall rules
2. **[SAF-M-45: Authentication Requirements](../../mitigations/SAF-M-45/README.md)**: Implement mandatory authentication for all MCP tool enumeration operations
3. **[SAF-M-46: Localhost Binding](../../mitigations/SAF-M-46/README.md)**: Configure MCP servers to bind only to localhost (127.0.0.1) unless external access is explicitly required
4. **[SAF-M-47: Tool Access Controls](../../mitigations/SAF-M-47/README.md)**: Implement granular permissions for tool discovery and enumeration operations
5. **[SAF-M-48: Planning Verification System](../../mitigations/SAF-M-48/README.md)**: Require explicit user approval of tool execution plans before invocation
6. **[SAF-M-49: Service Discovery Restrictions](../../mitigations/SAF-M-49/README.md)**: Disable or protect service discovery mechanisms in production environments
7. **[SAF-M-50: DNS Security Controls](../../mitigations/SAF-M-50/README.md)**: Implement DNS rebinding protections and restrict localhost resolution
8. **[SAF-M-51: Protocol Security Headers](../../mitigations/SAF-M-51/README.md)**: Configure proper CORS policies and security headers for MCP endpoints

### Detective Controls
1. **[SAF-M-52: Network Traffic Analysis](../../mitigations/SAF-M-52/README.md)**: Monitor network traffic for MCP enumeration patterns and anomalous scanning
2. **[SAF-M-53: Protocol Logging](../../mitigations/SAF-M-53/README.md)**: Implement comprehensive logging of MCP protocol interactions and tool access
3. **[SAF-M-54: Behavioral Analytics](../../mitigations/SAF-M-54/README.md)**: Use behavioral analysis to detect systematic reconnaissance activities
4. **[SAF-M-55: Threat Intelligence Integration](../../mitigations/SAF-M-55/README.md)**: Incorporate MCP-specific threat intelligence and indicators
...
### SAF-T1601.001: Network Port Scanning
...
### SAF-T1601.002: Protocol-Level Enumeration
...
### SAF-T1601.003: DNS Rebinding Enumeration
...
### SAF-T1601.004: Cloud Infrastructure Scanning
...
## Related Techniques
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Often preceded by enumeration to identify vulnerable tools
- [SAF-T1104](../SAF-T1104/README.md): Over-Privileged Tool Abuse - Exploits tools discovered through enumeration
- [SAF-T1102](../SAF-T1102/README.md): Prompt Injection - Uses enumerated tool information to craft targeted attacks
- [SAF-T1602](../SAF-T1602/README.md): Tool Enumeration - Related reconnaissance technique focusing on tool-level discovery
- [SAF-T1703](../SAF-T1703/README.md): Tool-Chaining Pivot - Uses enumeration results to identify tool relationships for chaining attacks
...
| 1.1 | 2025-12-28 | Enhanced documentation with Mermaid attack flow diagram, comprehensive citations, sub-techniques taxonomy, and improved technical depth matching SAF-T1001 quality standard | Shashanka Ghimire|
