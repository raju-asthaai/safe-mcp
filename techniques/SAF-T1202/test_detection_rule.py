#!/usr/bin/env python3
"""
Test Suite for SAF-T1202: OAuth Token Persistence Detection Rule
...
class TestOAuthTokenPersistenceDetection(unittest.TestCase):
    """Test cases for SAF-T1202 detection rule"""
    ...
    def evaluate_detection_rule(self, logs):
        """
        Simulate the detection rule logic based on SAF-T1202 detection-rule.yml
