...
title: SAF-T1404 MCP Response Tampering (Narrative/Tool Mismatch)
...
### Preventive Controls
1. **[SAF-M-45: Tool Manifest Signing & Server Attestation](../../mitigations/SAF-M-45/README.md)**: Treat tool metadata as untrusted without strong provenance; reduce the chance of instruction-bearing metadata being accepted at all.
2. **[SAF-M-10: Automated Scanning](../../mitigations/SAF-M-10/README.md)**: Scan tool outputs and other MCP content for known malicious patterns before it reaches the LLM.
...
### Detective Controls
1. **[SAF-M-53: Multimodal Behavioral Monitoring](../../mitigations/SAF-M-53/README.md)**: Monitor for anomalies in tool invocations and response patterns after untrusted content ingestion.
...
## Related Techniques
- [SAF-T1401](../SAF-T1401/README.md): Line Jumping (context ordering can help place concealment directives early)
- [SAF-T1402](../SAF-T1402/README.md): Instruction Steganography (hidden directives used to tamper responses)
- [SAF-T2105](../SAF-T2105/README.md): Disinformation Output (selective omission overlaps with response tampering goals)
- [SAF-T1104](../SAF-T1104/README.md): Over-Privileged Tool Abuse (high-risk tools increase impact of tampering)
