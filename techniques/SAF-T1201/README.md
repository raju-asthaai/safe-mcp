...
date: 2025-01-15
references:
  - https://github.com/saf-mcp/techniques/SAF-T1201
...
### Preventive Controls
1. **[SAF-M-44: Tool Integrity Monitoring](../../mitigations/SAF-M-44/README.md)**: Implement continuous monitoring of tool definitions and behavior patterns
2. **[SAF-M-45: Cryptographic Tool Signing](../../mitigations/SAF-M-45/README.md)**: Require cryptographic signatures for all tool definitions and updates
3. **[SAF-M-46: Behavioral Baseline Establishment](../../mitigations/SAF-M-46/README.md)**: Establish and monitor behavioral baselines for all approved tools
4. **[SAF-M-47: Tool Versioning Controls](../../mitigations/SAF-M-47/README.md)**: Implement strict versioning and change approval processes for tool updates
5. **[SAF-M-48: Provenance Tracking](../../mitigations/SAF-M-48/README.md)**: Maintain detailed provenance records for all tool sources and modifications
6. **[SAF-M-49: Sandboxed Tool Execution](../../mitigations/SAF-M-49/README.md)**: Execute tools in isolated environments with limited system access
7. **[SAF-M-50: Time-Based Re-approval](../../mitigations/SAF-M-50/README.md)**: Require periodic re-approval of tools based on continued behavioral analysis
8. **[SAF-M-51: Network Segmentation](../../mitigations/SAF-M-51/README.md)**: Isolate tool network access and monitor for unauthorized connections

### Detective Controls
1. **[SAF-M-52: Anomaly Detection Systems](../../mitigations/SAF-M-52/README.md)**: Deploy ML-based systems to detect changes in tool behavior patterns
2. **[SAF-M-53: Tool Activity Correlation](../../mitigations/SAF-M-53/README.md)**: Correlate tool activities with user actions and system events
3. **[SAF-M-54: Communication Monitoring](../../mitigations/SAF-M-54/README.md)**: Monitor tool server communications for unauthorized updates or signals
4. **[SAF-M-55: Performance Profiling](../../mitigations/SAF-M-55/README.md)**: Profile tool performance characteristics to detect functional changes
...
## Related Techniques
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Initial attack vector that may lead to rug pull
- [SAF-T1002](../SAF-T1002/README.md): Supply Chain Compromise - Related attack vector for tool deployment
- [SAF-T1204](../SAF-T1204/README.md): Context Memory Implant - Similar persistence mechanism
- [SAF-T1205](../SAF-T1205/README.md): Persistent Tool Redefinition - Related persistence technique
