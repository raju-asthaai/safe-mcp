...
date: 2025-12-03
references:
  - https://github.com/saf-mcp/techniques/SAF-T1910
logsource:
  product: mcp
...
### Preventive Controls
1.  **[SAF-M-5: Content Sanitization](../../mitigations/SAF-M-5/README.md)**: Enforce strict JSON schemas. Use regex patterns to limit allowed character sets (e.g., `^[a-zA-Z\s]+$` for city names). Reject inputs exceeding expected lengths.
...
### Detective Controls
1.  **[SAF-M-11: Behavioral Monitoring](../../mitigations/SAF-M-11/README.md)**: Analyze the statistical distribution of tool argument lengths and entropy.
...
## Related Techniques
- [SAF-T1904](../SAF-T1904/README.md): Chat-Based Backchannel - Uses the chat stream itself for exfiltration.
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning - Often the precursor allowing the attacker to control tool calls.
