...
## Description
Server Version Enumeration is a reconnaissance technique where adversaries identify MCP server software versions through endpoint probing and HTTP header analysis. Unlike general server enumeration (SAF-T1601), this technique specifically targets version strings to map vulnerable builds and enable targeted exploitation.
...
date: 2025-01-26
references:
  - https://github.com/saf-mcp/techniques/SAF-T1604
logsource:
  category: webserver
  product: nginx
detection:
...
### Preventive Controls
1. **[SAF-M-14: Server Allowlisting](../../mitigations/SAF-M-14/README.md)**: Restrict MCP server access to trusted clients; deny access to version endpoints from untrusted sources
2. **[SAF-M-45: Tool Manifest Signing & Server Attestation](../../mitigations/SAF-M-45/README.md)**: Implement cryptographic identity verification before exposing any server metadata
3. **[SAF-M-5: Content Sanitization](../../mitigations/SAF-M-5/README.md)**: Filter error responses to prevent stack trace and version disclosure through error messages
...
### Detective Controls
1. **[SAF-M-12: Audit Logging](../../mitigations/SAF-M-12/README.md)**: Log all requests to version-related endpoints with source IP, user-agent, and response details
2. **[SAF-M-11: Behavioral Monitoring](../../mitigations/SAF-M-11/README.md)**: Track patterns of version endpoint access to detect systematic enumeration attempts
3. **[SAF-M-36: Model Behavior Monitoring](../../mitigations/SAF-M-36/README.md)**: Monitor for anomalies following version disclosure that may indicate follow-on exploitation
...
## Related Techniques
- [SAF-T1601](../SAF-T1601/README.md): MCP Server Enumeration - Parent technique; version enumeration often follows server discovery
- [SAF-T1602](../SAF-T1602/README.md): Tool Enumeration - Follow-on technique; enumerate exploitable tools after identifying vulnerable versions
- [SAF-T1605](../SAF-T1605/README.md): Capability Mapping - Complementary technique; version + capabilities = complete attack surface
- [SAF-T1101](../SAF-T1101/README.md): Command Injection - Exploitation technique; version info enables targeting known injection flaws
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Exploitation technique; vulnerable versions may be susceptible to tool poisoning
