...
date: 2025-11-19
references:
  - https://github.com/SAF-MCP/saf-mcp
...
1. **[SAF-M-1: Architectural Defense - Control/Data Flow Separation](../../mitigations/SAF-M-1/README.md)**: Implement CaMeL or similar systems that enforce strict separation between control instructions and untrusted data, preventing context-based instruction injection
2. **[SAF-M-24: Context Structure Validation](../../mitigations/SAF-M-24/README.md)**: Validate and sanitize all content before it enters the context window, especially from untrusted sources like tool outputs and file contents
3. **[SAF-M-21: Output Context Isolation](../../mitigations/SAF-M-21/README.md)**: Use structured formatting to clearly separate different context sources and prevent instruction bleed-through
4. **[SAF-M-5: Content Sanitization](../../mitigations/SAF-M-5/README.md)**: Filter all MCP-related content to remove instruction patterns, fake delimiters, and system directive attempts
...
1. **[SAF-M-10: Automated Scanning](../../mitigations/SAF-M-10/README.md)**: Scan all content entering context for line jumping patterns, fake delimiters, and precedence manipulation attempts
2. **[SAF-M-11: Behavioral Monitoring](../../mitigations/SAF-M-11/README.md)**: Monitor for security policy inconsistencies and sudden changes in AI behavior that indicate bypassed checkpoints
3. **[SAF-M-12: Audit Logging](../../mitigations/SAF-M-12/README.md)**: Log full context structure including ordering and sources to enable forensic analysis of line jumping attempts
...
- [SAF-T1102](../SAF-T1102/README.md): Prompt Injection - Broader category that includes line jumping
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Can be combined with line jumping for enhanced impact
- [SAF-T1402](../SAF-T1402/README.md): Instruction Steganography - Another method to hide malicious directives
