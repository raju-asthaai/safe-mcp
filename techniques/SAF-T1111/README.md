...
date: 2025-08-27
references:
  - https://github.com/saf-mcp/techniques/SAF-T1111
...
### Preventive Controls
1. **[SAF-M-2: Input Validation](../../mitigations/SAF-M-2/README.md)**: Validate and sanitize package install scripts before execution
2. **[SAF-M-4: Access Control](../../mitigations/SAF-M-4/README.md)**: Implement strict access controls for AI CLI tools and dangerous flags
...
## Related Techniques
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Similar supply chain compromise vector
- [SAF-T1102](../SAF-T1102/README.md): Prompt Injection - Foundation technique for AI manipulation
- [SAF-T1104](../SAF-T1104/README.md): Over-Privileged Tool Abuse - Related abuse of tool permissions
- [SAF-T1601](../SAF-T1601/README.md): MCP Server Enumeration - Similar reconnaissance techniques
