...
## Description
Persistent Tool Redefinition is an attack technique where adversaries modify MCP server tool metadata and configuration files to maintain hidden malicious commands across system restarts. Unlike time-delayed rug pull attacks (SAF-T1201), this technique directly modifies persistent storage elements such as tool definition files, server configuration databases, and initialization scripts to ensure malicious tool behavior survives server restarts and updates.
...
3. **Description Poisoning**: Embedding hidden instructions in tool descriptions that persist across restarts (combines with SAF-T1001)
...
date: 2025-12-16
references:
  - https://github.com/SAF-MCP/saf-mcp/techniques/SAF-T1205
...
### Preventive Controls
1. **[SAF-M-45: Cryptographic Tool Signing](../../mitigations/SAF-M-45/README.md)**: Implement cryptographic signatures for all tool definitions; verify signatures during server initialization before loading any tools
2. **[SAF-M-44: Tool Integrity Monitoring](../../mitigations/SAF-M-44/README.md)**: Deploy file integrity monitoring (FIM) for all MCP configuration directories and tool definition files
3. **[SAF-M-47: Tool Versioning Controls](../../mitigations/SAF-M-47/README.md)**: Implement strict version control for tool definitions with approval workflows and audit trails
4. **[SAF-M-9: Sandboxed Execution](../../mitigations/SAF-M-9/README.md)**: Run MCP servers with read-only configuration filesystems where possible; use immutable container images
5. **[SAF-M-19: Least Privilege](../../mitigations/SAF-M-19/README.md)**: Restrict write access to tool definition storage to only authorized administrative processes
...
### Detective Controls
1. **[SAF-M-12: Audit Logging](../../mitigations/SAF-M-12/README.md)**: Log all access to tool definition files and database tables with full attribution
2. **[SAF-M-52: Anomaly Detection Systems](../../mitigations/SAF-M-52/README.md)**: Deploy ML-based anomaly detection to identify unusual patterns in tool definitions
3. **[SAF-M-46: Behavioral Baseline Establishment](../../mitigations/SAF-M-46/README.md)**: Establish and continuously compare tool behavior baselines; alert on deviations
...
## Related Techniques
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Similar concept but focuses on description-based poisoning rather than persistent file modification
- [SAF-T1201](../SAF-T1201/README.md): MCP Rug Pull Attack - Time-delayed modification vs. persistent file-based modification
- [SAF-T1204](../SAF-T1204/README.md): Context Memory Implant - Persistence through vector store rather than configuration files
- [SAF-T1002](../SAF-T1002/README.md): Supply Chain Compromise - May be used to initially introduce malicious tool definitions
- [SAF-T1301](../SAF-T1301/README.md): Cross-Server Tool Shadowing - Different persistence vector but similar goal of tool manipulation
...
|---------|------|---------|--------|
| 1.0 | 2025-12-16 | Initial documentation of Persistent Tool Redefinition technique | SAF-MCP Contributors |
