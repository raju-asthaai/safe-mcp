# SAF-T1303: Container Sandbox Escape via Runtime Exec
...
2. **SAF-M-11: Behavioral Monitoring**: Alert on abnormal container `exec` patterns and host-path access from containerized processes.
...
- [SAF-T1109](../SAF-T1109/README.md): Debugging Tool Exploitation
