...
date: 2025-09-13
references:
  - https://github.com/saf-mcp/techniques/SAF-T2107
logsource:
  product: mcp
...
### Preventive Controls
1. **[SAF-M-33: Training Data Provenance Verification](../../mitigations/SAF-M-33/README.md)**: Implement cryptographic verification of training data sources and transformations
2. **[SAF-M-34: AI Model Integrity Validation](../../mitigations/SAF-M-34/README.md)**: Deploy model validation techniques to detect and prevent poisoned models
3. **[SAF-M-35: Adversarial Training Data Detection](../../mitigations/SAF-M-35/README.md)**: Use machine learning techniques to identify and filter poisoned training data
4. **[SAF-M-36: Model Behavior Monitoring](../../mitigations/SAF-M-36/README.md)**: Implement continuous monitoring of model behavior for anomalies
...
- [SAF-T1102](../SAF-T1102/README.md): Prompt Injection - Temporary manipulation vs. persistent poisoning
- [SAF-T2106](../SAF-T2106/README.md): Context Memory Poisoning - Similar persistence mechanism
...
|---------|------|---------|--------|
| 1.0 | 2025-09-13 | Initial documentation of SAF-T2107 technique | Sachin Keswani |
