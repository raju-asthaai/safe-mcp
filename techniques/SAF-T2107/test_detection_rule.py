#!/usr/bin/env python3
"""
Test script for SAF-T2107 detection rule
...
class SAFT2107DetectionTester:
    ...
    def run_tests(self) -> TestResult:
        ...
        print("Running SAF-T2107 Detection Rule Tests")
        print("=" * 50)
    ...
    def print_results(self, result: TestResult):
        ...
        print("\n" + "=" * 50)
        print("SAF-T2107 DETECTION RULE TEST RESULTS")
        print("=" * 50)
...
def main():
    ...
    tester = SAFT2107DetectionTester(
