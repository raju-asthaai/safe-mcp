...
date: 2025-01-09
references:
  - https://github.com/saf-mcp/techniques/SAF-T1102
logsource:
  product: mcp
  service: tool_output
detection:
...
### Preventive Controls
1. **[SAF-M-1: Architectural Defense - Control/Data Flow Separation](../../mitigations/SAF-M-1/README.md)**: Implement control/data flow separation to ensure tool outputs cannot influence program execution
2. **[SAF-M-5: Content Sanitization](../../mitigations/SAF-M-5/README.md)**: Filter all MCP-related content to remove hidden content and instruction patterns
3. **[SAF-M-7: Content Rendering Parity](../../mitigations/SAF-M-7/README.md)**: Ensure displayed content matches content sent to the LLM for all content types
4. **[SAF-M-21: Output Context Isolation](../../mitigations/SAF-M-21/README.md)**: Use structured formatting to clearly separate tool outputs from system instructions
5. **[SAF-M-22: Semantic Output Validation](../../mitigations/SAF-M-22/README.md)**: Validate tool outputs match expected formats and don't contain instruction patterns
6. **[SAF-M-23: Tool Output Truncation](../../mitigations/SAF-M-23/README.md)**: Limit the size of tool outputs to prevent context overwhelm attacks

### Detective Controls
1. **[SAF-M-10: Automated Scanning](../../mitigations/SAF-M-10/README.md)**: Scan all MCP content including outputs for malicious patterns
2. **[SAF-M-11: Behavioral Monitoring](../../mitigations/SAF-M-11/README.md)**: Monitor for prompt injection signs like context switches or unrelated commands
3. **[SAF-M-12: Audit Logging](../../mitigations/SAF-M-12/README.md)**: Log all tool outputs and their full content for forensic analysis
...
## Related Techniques
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Similar injection through different vector
- [SAF-T1103](../SAF-T1103/README.md): Indirect Prompt Injection - Specific subset focusing on third-party data
- [SAF-T1401](../SAF-T1401/README.md): Line Jumping - Can be combined with prompt injection
