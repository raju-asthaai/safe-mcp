...
### Preventive Controls
1. **[SAF-M-53: Schema Validation and Sanitization](../../mitigations/SAF-M-53/README.md)**: Implement comprehensive validation of all schema components
2. **[SAF-M-54: Content Security Policies for Schemas](../../mitigations/SAF-M-54/README.md)**: Apply CSP-like policies to restrict schema content
3. **[SAF-M-55: Schema Signing and Verification](../../mitigations/SAF-M-55/README.md)**: Cryptographically sign and verify tool schemas
4. **[SAF-M-56: Least Privilege Schema Design](../../mitigations/SAF-M-56/README.md)**: Design schemas with minimal required information exposure
5. **[SAF-M-57: Automated Schema Analysis](../../mitigations/SAF-M-57/README.md)**: Use AI-based tools to analyze schemas for malicious patterns
6. **[SAF-M-58: Schema Allowlisting](../../mitigations/SAF-M-58/README.md)**: Maintain allowlists of approved schema patterns and components
7. **[SAF-M-59: Output Filtering](../../mitigations/SAF-M-59/README.md)**: Filter tool outputs to prevent credential leakage

### Detective Controls
1. **[SAF-M-60: Schema Change Monitoring](../../mitigations/SAF-M-60/README.md)**: Monitor and alert on schema modifications
2. **[SAF-M-61: Credential Access Auditing](../../mitigations/SAF-M-61/README.md)**: Audit and log all credential access attempts
3. **[SAF-M-62: Response Content Analysis](../../mitigations/SAF-M-62/README.md)**: Analyze tool responses for embedded sensitive information
...
## Related Techniques
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Base technique that FSP extends
- [SAF-T1502](../SAF-T1502/README.md): File-Based Credential Harvest - Often the goal of FSP attacks
- [SAF-T1504](../SAF-T1504/README.md): Token Theft via API Response - Related credential theft method
