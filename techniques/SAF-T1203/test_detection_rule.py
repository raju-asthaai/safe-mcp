#!/usr/bin/env python3
"""
Test Suite for SAF-T1203: Backdoored Server Binary (Install-Time Persistence)
...
class TestSafeT1203Detection(unittest.TestCase):
    """Test cases for SAF-T1203 detection logic."""

    # Keep these lists aligned with techniques/SAF-T1203/detection-rule.yml
