...
date: 2025-11-15
references:
  - https://github.com/saf-mcp/techniques/SAF-T1504
...
## Related Techniques
- [SAF-T1503](../SAF-T1503/README.md): Env-Var Scraping - Related credential access via file reading tools
- [SAF-T1001](../SAF-T1001/README.md): Prompt Injection - Primary enabler for convincing LLM to call token tools
- [SAF-T1301](../SAF-T1301/README.md): Data Exfiltration via HTTP - Secondary technique for stealthy token exfiltration
