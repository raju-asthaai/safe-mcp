...
date: 2025-01-02
references:
  - https://github.com/pritikabista/saf-mcp/blob/main/techniques/SAF-T1304/README.md
logsource:
  product: mcp
...
### Preventive Controls
1. **[SAF-M-1: Architectural Defense - CaMeL](../../mitigations/SAF-M-1/README.md)**: Implement control/data flow separation to prevent unauthorized credential sharing between tools
2. **[SAF-M-2: Cryptographic Integrity](../../mitigations/SAF-M-2/README.md)**: Use cryptographically bound tokens that cannot be relayed to unauthorized tools
3. **[SAF-M-6: Tool Registry Verification](../../mitigations/SAF-M-6/README.md)**: Implement strict access controls and privilege separation between MCP tools
4. **[SAF-M-12: Audit Logging](../../mitigations/SAF-M-12/README.md)**: Log all token usage and cross-tool authentication attempts
...
2. **[SAF-M-11: Behavioral Monitoring](../../mitigations/SAF-M-11/README.md)**: Monitor for rapid privilege escalation and unusual authentication patterns
...
## Related Techniques
- [SAF-T1504](../SAF-T1504/README.md): Token Theft via API Response - Common method for initial credential acquisition
- [SAF-T1301](../SAF-T1301/README.md): Cross-Server Tool Shadowing - Related privilege escalation technique
- [SAF-T1706](../SAF-T1706/README.md): OAuth Token Pivot Replay - Similar cross-service token usage
