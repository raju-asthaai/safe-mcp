...
The detection rules and executable harness included with SAF-T1605 are **illustrative reference implementations**, not production-tuned signatures. They are intended to demonstrate *observable patterns* of capability enumeration behavior rather than prescribe fixed thresholds or phrases.
...
SAF-T1605 also aligns with reconnaissance concepts from MITRE ATT&CK adversary emulation, adapted for LLM-mediated and agent-orchestrated systems.
