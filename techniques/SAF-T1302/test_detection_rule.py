#!/usr/bin/env python3
"""
Test script for SAF-T1302 High-Privilege Tool Abuse detection rule validation.
...
class PrivilegedToolDetector:
    """Detector for High-Privilege Tool Abuse based on SAF-T1302 rule."""
...
def main():
    ...
    print("🔍 SAF-T1302 High-Privilege Tool Abuse Detection Results")
    print("=" * 60)
