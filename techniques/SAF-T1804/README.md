...
1. **[SAF-M-13: Rate Limiting and Quotas](../../mitigations/SAF-M-13/README.md)**: Implement strict MCP tool invocation rate limiting per agent, session, and time window
...
2. **[SAF-M-14: API Access Allowlisting](../../mitigations/SAF-M-14/README.md)**: Restrict which APIs each MCP tool can access based on principle of least privilege
...
3. **[SAF-M-15: Data Volume Monitoring](../../mitigations/SAF-M-15/README.md)**: Track cumulative data returned from MCP tools per agent and session
...
4. **[SAF-M-16: Query Pattern Analysis](../../mitigations/SAF-M-16/README.md)**: Detect systematic enumeration and batch query patterns through MCP tools
...
5. **[SAF-M-3: AI-Powered Content Analysis](../../mitigations/SAF-M-3/README.md)**: Analyze MCP prompts for data harvesting intent using semantic understanding
...
6. **[SAF-M-17: API Response Filtering](../../mitigations/SAF-M-17/README.md)**: Limit sensitive fields in API responses accessible through MCP tools
...
7. **[SAF-M-18: Architectural Segmentation](../../mitigations/SAF-M-18/README.md)**: Separate high-value data APIs from general MCP agent access
...
1. **[SAF-M-11: Behavioral Monitoring](../../mitigations/SAF-M-11/README.md)**: Monitor MCP agent behavior for systematic data collection patterns over time
...
2. **[SAF-M-12: Audit Logging](../../mitigations/SAF-M-12/README.md)**: Comprehensive logging of all MCP tool invocations, prompts, and data returned
...
3. **[SAF-M-19: Aggregate Analytics](../../mitigations/SAF-M-19/README.md)**: Analyze aggregate MCP data exposure trends rather than individual tool queries
...
- [SAF-T1102](../SAF-T1102/README.md): Prompt Injection - Primary attack vector for manipulating MCP agents into API harvesting
- [SAF-T1802](../SAF-T1802/README.md): File Collection - Related bulk data collection through MCP file tools
- [SAF-T1803](../SAF-T1803/README.md): Database Dump - Similar systematic data extraction via MCP database tools
- [SAF-T1805](../SAF-T1805/README.md): Context Snapshot Capture - Complementary MCP vector database extraction technique
- [SAF-T1910](../SAF-T1910/README.md): Covert Channel Exfiltration - Methods used to exfiltrate data harvested through MCP tools
- [SAF-T1914](../SAF-T1914/README.md): Tool-to-Tool Exfil - Chaining MCP tools to exfiltrate harvested data
