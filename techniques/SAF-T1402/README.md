# SAF-T1402: Instruction Stenography - Tool Metadata Poisoning

## Overview

**Tactic**: Defense Evasion (ATK-TA0005)
**Technique ID**: SAF-T14002
**Severity**: High  
...
1. **[SAF-M-37: Metadata Sanitization](../../mitigations/SAF-M-37/README.md)**: Strip zero-width characters and HTML comments from tool metadata
2. **[SAF-M-38: Schema Validation](../../mitigations/SAF-M-38/README.md)**: Enforce strict schemas for tool registration
3. **[SAF-M-39: Prompt Context Isolation](../../mitigations/SAF-M-39/README.md)**: Separate tool metadata from user prompt context
4. **[SAF-M-40: Clear UI Patterns](../../mitigations/SAF-M-40/README.md)**: Visible tool descriptions that distinguish which parts are visible to the AI model
5. **[SAF-M-41: Tool and Package Pinning](../../mitigations/SAF-M-41/README.md)**: Pin versions and use certificates, hashes or checksums to verify integrity.
6. **[SAF-M-42: Cross-Server Protection](../../mitigations/SAF-M-42/README.md)**: Strict boundaries and data flow controls between MCP servers

### Detective Controls

1. **[SAF-M-43: Steganography Scanner](../../mitigations/SAF-M-43/README.md)**: Use tools like MCP-Scan to audit tool configurations
2. **[SAF-M-44: Behavioral Monitoring](../../mitigations/SAF-M-44/README.md)**: Monitor agent output for signs of prompt injection
...
- [SAF-T1401](../SAF-T1401/README.md): Direct Prompt Injection – Related manipulation of model behavior via user input
- [SAF-T1403](../SAF-T1403/README.md): Context Poisoning – Persistent manipulation across agent workflows
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Using Metadata attacks for initial access
