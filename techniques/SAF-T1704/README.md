...
```json
{
  "attack_flow": {
    "step_1": {
      ...
      "method": "Tool poisoning attack (SAF-T1001)",
...
### Preventive Controls
1. **[SAF-M-1: Strong Authentication](../../mitigations/SAF-M-1/README.md)**: Enforce mutual TLS and signed server responses
2. **[SAF-M-5: Context Boundary Isolation](../../mitigations/SAF-M-5/README.md)**: Limit shared contexts between tools and servers
3. **[SAF-M-11: Server Hardening](../../mitigations/SAF-M-11/README.md)**: Apply least privilege and segregate MCP server roles
4. **[SAF-M-63: Least Privilege for MCP Servers](../../mitigations/SAF-M-63/README.md)**: Apply principle of least privilege to MCP servers, granting only the minimum necessary access to workspace resources
...
### Detective Controls
1. **[SAF-M-7: Response Validation](../../mitigations/SAF-M-7/README.md)**: Validate task-origin metadata and enforce strict schema
2. **[SAF-M-15: Behavioral Anomaly Detection](../../mitigations/SAF-M-15/README.md)**: Detect suspicious command patterns or task chains
...
## Related Techniques
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Common initial compromise vector for MCP servers
- [SAF-T1003](../SAF-T1003/README.md): Malicious MCP-Server Distribution - Initial access method that can lead to server compromise
- [SAF-T1005](../SAF-T1005/README.md): Exposed Endpoint Exploit - Initial access vector for server compromise
- [SAF-T1701](../SAF-T1701/README.md): Cross-Tool Contamination - Related lateral movement technique using compromised tools; attack expands via shared context poisoning
- [SAF-T1703](../SAF-T1703/README.md): Tool-Chaining Pivot - Similar pivoting technique but focused on tool-to-tool execution paths
- [SAF-T1104](../SAF-T1104/README.md): Over-Privileged Tool Abuse - Over-privileged servers enable more effective pivoting
...
| 2.0 | 2025-01-20 | Major revision: expanded attack vectors, detailed workspace pivot scenarios, comprehensive Sigma rules, and new mitigations (SAF-M-58 through SAF-M-68) | Pritika Bista |
| 2.1 | 2025-02-17 | Merged unique content from v1.0: added T1570 mapping, arXiv research references, server-side context injection technique, original mitigations (SAF-M-1/5/7/11/15), and additional IoCs | bishnubista |
