...
### Preventive Controls
1. **[SAF-M-1: Architectural Defense - CaMeL](../../mitigations/SAF-M-1/README.md)**: According to [research from Google et al. (2025)](https://arxiv.org/abs/2503.18813), implementing control/data flow separation through systems like CaMeL can provide provable security against prompt injection by ensuring untrusted tool descriptions cannot influence program execution
2. **[SAF-M-2: Cryptographic Integrity](../../mitigations/SAF-M-2/README.md)**: Tool descriptions should be cryptographically hashed and signed by trusted authorities, with signature verification before loading
3. **[SAF-M-3: AI-Powered Content Analysis](../../mitigations/SAF-M-3/README.md)**: Deploy LLM-based systems to analyze tool descriptions for semantic anomalies and hidden instructions before they reach production systems
4. **[SAF-M-4: Unicode Sanitization](../../mitigations/SAF-M-4/README.md)**: Implement filtering for:
...
5. **[SAF-M-5: Tool Description Sanitization](../../mitigations/SAF-M-5/README.md)**: Filter tool descriptions to remove hidden content and instruction patterns (note: pattern-based filtering alone is insufficient)
6. **[SAF-M-6: Tool Registry Verification](../../mitigations/SAF-M-6/README.md)**: Install MCP servers only from verified sources with cryptographic signatures
7. **[SAF-M-7: Description Rendering Parity](../../mitigations/SAF-M-7/README.md)**: Ensure displayed content matches content sent to the LLM
8. **[SAF-M-8: Visual Validation](../../mitigations/SAF-M-8/README.md)**: Compare visual rendering of descriptions with actual content to detect invisible characters ([Source: Promptfoo Research](https://www.promptfoo.dev/blog/invisible-unicode-threats/))
9. **[SAF-M-9: Sandboxed Testing](../../mitigations/SAF-M-9/README.md)**: Test new tools in isolated environments with monitoring before production deployment

### Detective Controls
1. **[SAF-M-10: Automated Scanning](../../mitigations/SAF-M-10/README.md)**: Regularly scan tool descriptions for known malicious patterns and hidden content
2. **[SAF-M-11: Behavioral Monitoring](../../mitigations/SAF-M-11/README.md)**: Monitor LLM behavior for unexpected tool usage patterns
3. **[SAF-M-12: Audit Logging](../../mitigations/SAF-M-12/README.md)**: Log all tool descriptions loaded and their full content
...
## Related Techniques
- [SAF-T1102](../SAF-T1102/README.md): Prompt Injection - Manipulation through different vector
- [SAF-T1002](../SAF-T1002/README.md): Supply Chain Compromise - Common distribution method for poisoned tools
- [SAF-T1401](../SAF-T1401/README.md): Line Jumping - Can be combined with TPA
