...
date: 2025-11-26
references:
  - https://github.com/saf-mcp/techniques/SAF-T1606
logsource:
  product: mcp
...
### Preventive Controls
1. **[SAF-M-14: Server Allowlisting](../../mitigations/SAF-M-14/README.md)**: Restrict which MCP servers are allowed to run.
...
3. **[SAF-M-9: Sandboxed Testing](../../mitigations/SAF-M-9/README.md)**: Run MCP servers in isolated containers (e.g., Docker) with limited file system mounts to prevent access to the host's sensitive files.
4. **[SAF-M-29: Explicit Privilege Boundaries](../../mitigations/SAF-M-29/README.md)**: Ensure tools operate with the least privilege necessary.

### Detective Controls
1. **[SAF-M-12: Audit Logging](../../mitigations/SAF-M-12/README.md)**: Log all tool executions, specifically capturing the `path` arguments for directory listing operations.
2. **[SAF-M-11: Behavioral Monitoring](../../mitigations/SAF-M-11/README.md)**: Monitor for anomalous patterns of file system traversal (e.g., rapid enumeration of multiple directories).

## Related Techniques
- [SAF-T1601](../SAF-T1601/README.md): MCP Server Enumeration - Discovering available servers.
- [SAF-T1802](../SAF-T1802/README.md): File Collection - Reading the files discovered via directory listing.
