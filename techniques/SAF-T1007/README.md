...
date: 2025-01-06
references:
  - https://github.com/saf-mcp/techniques/SAF-T1007
...
### Preventive Controls
1. **[SAF-M-13: OAuth Flow Verification](../../mitigations/SAF-M-13/README.md)**: Implement protocol-level verification of OAuth authorization servers and callback URLs
2. **[SAF-M-14: Server Allowlisting](../../mitigations/SAF-M-14/README.md)**: Maintain and enforce a list of trusted MCP server domains
3. **[SAF-M-15: User Warning Systems](../../mitigations/SAF-M-15/README.md)**: Display clear warnings when OAuth flows are initiated, showing the requesting server and target service
4. **[SAF-M-16: Token Scope Limiting](../../mitigations/SAF-M-16/README.md)**: Enforce minimal OAuth scopes and warn on broad permission requests
5. **[SAF-M-17: Callback URL Restrictions](../../mitigations/SAF-M-17/README.md)**: Validate that OAuth callback URLs match the configured MCP server domain

### Detective Controls
1. **[SAF-M-18: OAuth Flow Monitoring](../../mitigations/SAF-M-18/README.md)**: Log and analyze all OAuth authorization attempts through MCP
2. **[SAF-M-19: Token Usage Tracking](../../mitigations/SAF-M-19/README.md)**: Monitor usage patterns of OAuth tokens obtained through MCP
3. **[SAF-M-20: Anomaly Detection](../../mitigations/SAF-M-20/README.md)**: Identify unusual patterns in OAuth requests across MCP servers
...
## Related Techniques
- [SAF-T1004](../SAF-T1004/README.md): Server Impersonation - Similar deception tactics
- [SAF-T1006](../SAF-T1006/README.md): User-Social-Engineering Install - Social engineering overlap
- [SAF-T1202](../SAF-T1202/README.md): OAuth Token Persistence - Post-compromise token usage
