...
- **Secondary Vectors**: 
  - Tool poisoning attacks (SAF-T1001) combined with excessive tool permissions
...
date: 2025-01-15
references:
  - https://github.com/saf-mcp/techniques/SAF-T1104
logsource:
...
### Preventive Controls
1. **[SAF-M-32: Principle of Least Privilege](../../mitigations/SAF-M-32/README.md)**: Configure tools with minimal necessary permissions using capability-based security models
2. **[SAF-M-33: Tool Permission Boundaries](../../mitigations/SAF-M-33/README.md)**: Implement strict permission boundaries using containers, chroot, or namespace isolation
3. **[SAF-M-34: Permission Validation](../../mitigations/SAF-M-34/README.md)**: Validate all tool operations against defined permission policies before execution
4. **[SAF-M-35: Tool Capability Auditing](../../mitigations/SAF-M-35/README.md)**: Regular auditing of tool permissions and capabilities to identify over-privileged configurations
5. **[SAF-M-36: Secure Tool Defaults](../../mitigations/SAF-M-36/README.md)**: Default MCP tool configurations should grant minimal permissions with explicit permission escalation
6. **[SAF-M-37: Runtime Permission Monitoring](../../mitigations/SAF-M-37/README.md)**: Monitor tool operations in real-time for permission boundary violations
7. **[SAF-M-38: Tool Sandboxing](../../mitigations/SAF-M-38/README.md)**: Execute tools in sandboxed environments with controlled resource access
8. **[SAF-M-39: User Approval Gates](../../mitigations/SAF-M-39/README.md)**: Require explicit user approval for high-privilege operations beyond tool scope

### Detective Controls
1. **[SAF-M-40: Permission Abuse Detection](../../mitigations/SAF-M-40/README.md)**: Monitor for tools accessing resources outside their intended scope
2. **[SAF-M-41: System Call Monitoring](../../mitigations/SAF-M-41/README.md)**: Use tools like sysdig or falco to monitor system calls from MCP processes
3. **[SAF-M-42: File Access Auditing](../../mitigations/SAF-M-42/README.md)**: Log and analyze file access patterns for unauthorized data access
4. **[SAF-M-43: Network Traffic Analysis](../../mitigations/SAF-M-43/README.md)**: Monitor network connections from tools for unexpected external communication
...
## Related Techniques
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Often combined with over-privileged tools for maximum impact
- [SAF-T1102](../SAF-T1102/README.md): Prompt Injection - Primary method for manipulating over-privileged tools
- [SAF-T1301](../SAF-T1301/README.md): Cross-Server Tool Shadowing - Can exploit over-privileged tool configurations
- [SAF-T1302](../SAF-T1302/README.md): High-Privilege Tool Abuse - Specific variant focusing on tools with administrative privileges
