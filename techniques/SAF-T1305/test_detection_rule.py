#!/usr/bin/env python3
"""
Test cases for SAF-T1305 Host OS Privilege Escalation (RCE) Detection Rule
...
class RootPrivilegeAbuseDetector:
    """Detector for Root Privilege Abuse based on SAF-T1305 rule."""
...
def test_rule_structure():
    ...
    assert "SAF-T1305" in rule.get("description", "") or "safe.t1305" in rule.get("tags", [])
