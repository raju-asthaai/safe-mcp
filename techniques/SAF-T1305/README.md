# SAF-T1305: Host OS Privilege Escalation (RCE)
...
date: 2025-12-09
references:
  - https://github.com/saf-mcp/techniques/SAF-T1305
...
### Preventive Controls
1. **[SAF-M-8: Principle of Least Privilege](../../mitigations/SAF-M-8/README.md)**: Run MCP servers as non-root users with minimal required permissions
2. **[SAF-M-9: Container Security Contexts](../../mitigations/SAF-M-9/README.md)**: Enforce `runAsNonRoot: true` and `allowPrivilegeEscalation: false` in Kubernetes/container deployments
3. **[SAF-M-10: Capability Dropping](../../mitigations/SAF-M-10/README.md)**: Drop all unnecessary Linux capabilities using `--cap-drop=ALL` and add only required ones
4. **[SAF-M-11: Read-Only Root Filesystem](../../mitigations/SAF-M-11/README.md)**: Deploy with `readOnlyRootFilesystem: true` to prevent filesystem modifications
5. **[SAF-M-12: User Namespace Isolation](../../mitigations/SAF-M-12/README.md)**: Use user namespaces to map container root to unprivileged host user
6. **[SAF-M-13: Seccomp Profiles](../../mitigations/SAF-M-13/README.md)**: Apply restrictive seccomp profiles to limit available syscalls
7. **[SAF-M-14: AppArmor/SELinux Policies](../../mitigations/SAF-M-14/README.md)**: Enforce mandatory access controls to restrict file and network access

### Detective Controls
1. **[SAF-M-15: Process Monitoring](../../mitigations/SAF-M-15/README.md)**: Monitor MCP server process execution context and child processes
2. **[SAF-M-16: File Integrity Monitoring](../../mitigations/SAF-M-16/README.md)**: Deploy FIM on sensitive system files to detect unauthorized access
3. **[SAF-M-17: Audit Logging](../../mitigations/SAF-M-17/README.md)**: Enable comprehensive audit logging for privileged operations
4. **[SAF-M-18: Runtime Security](../../mitigations/SAF-M-18/README.md)**: Use runtime security tools (Falco, Sysdig) to detect anomalous behavior
...
## Related Techniques
- [SAF-T1104](../SAF-T1104/README.md): Over-Privileged Tool Abuse - Broader category of privilege abuse
- [SAF-T1301](../SAF-T1301/README.md): Cross-Server Tool Shadowing - Can be combined for privilege escalation
- [SAF-T1303](../SAF-T1303/README.md): Sandbox Escape via Server Exec - Container breakout techniques
- [SAF-T1102](../SAF-T1102/README.md): Prompt Injection - Primary vector for initiating this attack
