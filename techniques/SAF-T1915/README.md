# SAF-T1915: Cross-Chain Laundering via Bridges/DEXs ("Chain-Hopping")
...
date: 2025-11-02
references:
  - https://github.com/SAF-MCP/saf-mcp/techniques/SAF-T1915
...
1. **[SAF-M-1: Input Validation](../../mitigations/SAF-M-1/README.md)**: Validate all blockchain transaction parameters and enforce allowlists for approved bridge protocols and destination chains
2. **[SAF-M-8: Rate Limiting](../../mitigations/SAF-M-8/README.md)**: Implement velocity limits on cross-chain bridge operations per session/user
3. **[SAF-M-19: Least Privilege](../../mitigations/SAF-M-19/README.md)**: Restrict MCP tool capabilities for blockchain operations; require explicit user consent for cross-chain transfers
4. **[SAF-M-46: Bridge Risk Management](../../mitigations/SAF-M-46/README.md)**: Maintain an updated list of high-risk bridge protocols and off-ramp services; block or require enhanced review for suspicious routes

### Detective Controls

1. **[SAF-M-2: Comprehensive Logging](../../mitigations/SAF-M-2/README.md)**: Log all bridge transactions with full cross-chain context including source chain, destination chain, bridge protocol, amounts, and addresses
2. **[SAF-M-10: Anomaly Detection](../../mitigations/SAF-M-10/README.md)**: Deploy AI-based anomaly detection for unusual multi-chain patterns and rapid bridge sequences
3. **[SAF-M-47: Cross-Chain Transaction Graph Analysis](../../mitigations/SAF-M-47/README.md)**: Implement bi-directional cross-chain tracing to link lock/mint/burn events across blockchain networks
4. **[SAF-M-48: Custodial Off-Ramp Monitoring](../../mitigations/SAF-M-48/README.md)**: Prioritize monitoring of known custodial services that historically receive concentrated illicit inflows
...
- **SAF-T1910**: Covert Channel Exfiltration - Chain-hopping extends covert exfiltration to blockchain value transfers
- **SAF-T1911**: Parameter Exfiltration - Bridge parameters can be used to encode additional data
- **SAF-T1913**: HTTP POST Exfil - Off-ramp deposits often use HTTP APIs
- **SAF-T1914**: Tool-to-Tool Exfil - Chain-hopping inherently chains multiple blockchain tools
- **SAF-T2104**: Fraudulent Transactions - Chain-hopping is often used to launder proceeds from fraudulent on-chain transactions

## References

- [SAF-MCP Repository - TTP Table](https://github.com/SAF-MCP/saf-mcp)
