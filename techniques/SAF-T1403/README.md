...
date: 2025-11-16
references:
  - https://github.com/saf-mcp/techniques/SAF-T1403
...
1. **[SAF-M-20: Adaptive Approval Friction](../../mitigations/SAF-M-20/README.md)**: Implement risk-based approval interfaces that introduce proportional cognitive friction for sensitive operations:
...
2. **[SAF-M-21: Approval Rate Limiting](../../mitigations/SAF-M-21/README.md)**: Enforce rate limits on permission requests per MCP server:
...
3. **[SAF-M-22: Contextual Approval Prompts](../../mitigations/SAF-M-22/README.md)**: Enhance approval interfaces with rich context:
...
4. **[SAF-M-23: Forced Delay for Sensitive Operations](../../mitigations/SAF-M-23/README.md)**: According to research on security habituation ([Forget et al., 2016](https://dl.acm.org/doi/10.1145/2858036.2858293)), introducing mandatory delays can disrupt automatic approval patterns:
...
5. **[SAF-M-24: Approval Pattern Baselining](../../mitigations/SAF-M-24/README.md)**: Establish behavioral baselines for each user:
...
6. **[SAF-M-25: Number-Matching for Critical Operations](../../mitigations/SAF-M-25/README.md)**: Implement Microsoft's number-matching approach for MCP context:
...
7. **[SAF-M-26: Approval Batching Prevention](../../mitigations/SAF-M-26/README.md)**: Prevent agents from queuing multiple approval requests:
...
8. **[SAF-M-27: Time-of-Day Risk Adjustment](../../mitigations/SAF-M-27/README.md)**: Increase security controls during high-fatigue periods:
...
1. **[SAF-M-28: Real-Time Habituation Detection](../../mitigations/SAF-M-28/README.md)**: Monitor approval sessions for signs of user fatigue:
...
2. **[SAF-M-29: Post-Approval Auditing](../../mitigations/SAF-M-29/README.md)**: Review approval decisions for anomalous patterns:
...
3. **[SAF-M-30: Approval Context Recording](../../mitigations/SAF-M-30/README.md)**: Log comprehensive context for forensic analysis:
...
### SAF-T1403.001: MFA Push Notification Bombing
...
### SAF-T1403.002: Incremental Permission Escalation
...
### SAF-T1403.003: Urgency-Framing Exploitation
...
### SAF-T1403.004: Multi-Agent Confusion Exploitation
...
### SAF-T1403.005: Temporal Pattern Exploitation
...
## Related Techniques
- [SAF-T1102](../SAF-T1102/README.md): Prompt Injection - Can be combined with consent fatigue to manipulate agent into generating approval requests
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - May use consent fatigue to get poisoned tools approved by users
- [SAF-T1201](../SAF-T1201/README.md): MCP Rug Pull Attack - Can leverage established approval patterns from consent fatigue
- [SAF-T1104](../SAF-T1104/README.md): Over-Privileged Tool Abuse - Consent fatigue enables approval of dangerous over-privileged operations
