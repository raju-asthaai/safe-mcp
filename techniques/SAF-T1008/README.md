...
date: 2025-01-15
references:
  - https://github.com/saf-mcp/techniques/SAF-T1008
...
### Preventive Controls
1. **[SAF-M-1: Architectural Defense - Control/Data Flow Separation](../../mitigations/SAF-M-1/README.md)**: Implement strict separation between trusted control flow and untrusted tool execution contexts
2. **[SAF-M-52: Preventive Control - Input Validation Pipeline](../../mitigations/SAF-M-52/README.md)**: Validate tool descriptions and metadata for suspicious patterns before registration
3. **Tool Identity Verification**: Implement cryptographic server authentication and unique tool identification mechanisms

### Detective Controls
1. **[SAF-M-51: AI-Based Defense - Embedding Anomaly Detection](../../mitigations/SAF-M-51/README.md)**: Monitor tool execution patterns for anomalies indicating shadowing attacks
...
## Related Techniques
- [SAF-T1001](../SAF-T1001/README.md): Tool Poisoning Attack - Similar technique using malicious tool descriptions
- [SAF-T1301](../SAF-T1301/README.md): Cross-Server Tool Shadowing - Related privilege escalation technique
- [SAF-T1102](../SAF-T1102/README.md): Prompt Injection - Can be combined with tool shadowing for enhanced impact
