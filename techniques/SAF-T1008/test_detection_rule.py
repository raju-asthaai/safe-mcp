#!/usr/bin/env python3
"""
Test cases for SAF-T1008 Tool Shadowing Attack detection rule.
...
def load_detection_rule():
    """Load the SAF-T1008 detection rule patterns."""
...
def load_test_logs():
    """Load test logs for SAF-T1008 scenarios."""
...
def run_all_tests():
    """Run all SAF-T1008 detection tests."""
    print("Running SAF-T1008 Tool Shadowing Attack detection tests...")
    print("=" * 60)
    ...
    if passed == total:
        print("🎉 All SAF-T1008 detection tests passed!")
        return True
    else:
