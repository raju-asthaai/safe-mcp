#!/usr/bin/env python3
"""
Test suite for SAF-T1105 Path Traversal via File Tool detection rule.
...
def test_tags() -> bool:
    ...
    required_tags = ['attack.execution', 'saf-mcp', 'saf-t1105', 'path-traversal']
...
def main():
    """Run all tests for the SAF-T1105 detection rule."""
    print("SAF-T1105 Path Traversal Detection Rule Test Suite")
    print("=" * 50)
